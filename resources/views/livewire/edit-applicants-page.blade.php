...
<form wire:submit="submitForm" class="max-w-lg mx-auto">
    ...
    <div class="mb-5">
        <label for="status" class="block mb-3 text-sm font-medium text-gray-900">Status</label>
        <select wire:model="form.status" id="status" class="bg-gray-50 border w-full border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
    ...
    <div class="mt-10 flex items-center justify-center">
        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit Applicant</button>
    </div>
</form>
</div>
</x-card>
